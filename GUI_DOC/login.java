...
public class login extends javax.swing.JFrame {
    ...
    private Upo u;
    /**
     * setup components for login page.
     */
    public login() {
        initComponents();
        u = Upo.getInstance();
    ...
    /**
     * check username and password if it matches any in database.
     * @param evt 
     */
    private void loginBtnActionPerformed(java.awt.event.ActionEvent evt) {        
        //replace it with function IsUsernameCorrect()
        IsUsernameCorrect();

    }     
    /**
     * Check whether or not username and password are correct.
     * if not, an error is shown. 
     * if yes, login page will be closed and NewsFeed will be opened.
     */
    public void IsUsernameCorrect(){
        ...
        setVisible(false);
                ...
                GUI.NewsFeed ob = new GUI.NewsFeed(u.getUserByUsername(username));
                //ob.setUser(username);
                ob.setVisible(true);
        }
        else{
